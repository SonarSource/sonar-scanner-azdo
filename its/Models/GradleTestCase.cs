...
namespace IntegrationTests.Models
{
	public class GradleTestCase : BuildTestCase
	{
		...
		{
			base.Coverage = Double.Parse(Environment.GetEnvironmentVariable("ITS_GRADLE_EXPECTED_COVERAGE"));
			base.NcLocs = Int64.Parse(Environment.GetEnvironmentVariable("ITS_GRADLE_EXPECTED_NCLOCS"));
