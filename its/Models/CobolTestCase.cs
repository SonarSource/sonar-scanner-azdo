...
namespace IntegrationTests.Models
{
	public class CobolTestCase : BuildTestCase
	{
		...
		{
			base.Coverage = Double.Parse(Environment.GetEnvironmentVariable("ITS_SCANNERCLI_EXPECTED_COVERAGE"));
			base.NcLocs = Int64.Parse(Environment.GetEnvironmentVariable("ITS_SCANNERCLI_EXPECTED_NCLOCS"));
